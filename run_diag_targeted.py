...
try:
    ...
    # Targeted search for a known MEI
    q = f'''
        ...
        FROM (
            ...
            WHERE estab.cnpj_basico = '21867599'
            LIMIT 1
        ) as estab
...
print('=== EXECUTANDO DIAGNÓSTICO TARGETED NO VPS ===')
client.exec_command("cat << 'EOF' > /tmp/diag_targeted.py\n" + diag_script + "\nEOF")
stdin, stdout, stderr = client.exec_command("/var/www/hemn_cloud/venv/bin/python3 /tmp/diag_targeted.py")
